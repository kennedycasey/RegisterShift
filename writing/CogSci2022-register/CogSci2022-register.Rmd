...
Child production data from the Language Development Project (LDP) longitudinal corpus were also analyzed <!--figure out how to properly cite-->. These included XX transcripts from XX children recorded every 4 months for approximately one hour from age 14 to 58 months.
...
path_to_models <- "../../analysis/model-outputs/input/"
