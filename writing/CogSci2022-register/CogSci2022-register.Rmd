...
Child production data from the Language Development Project (LDP) longitudinal corpus were also analyzed (REF). These included 622 transcripts from 59 children recorded every 4 months for approximately one hour from age 14 to 58 months. <!--kc2mc: I dropped the LDP data from the input predictor analyses since we don't have timestamps or lemmas, so we'd only really have data for the syntactic analyses. Seemed better to not introduce a bunch more NAs, but let me know what you think!-->
