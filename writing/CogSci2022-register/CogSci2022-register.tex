...
\hypertarget{study-2-what-linguistic-information-in-childrens-input-supports-their-shift-from-cdl-to-adl-words}{%
\section{Study 2: What linguistic information in children's input
supports their shift from CDL to ADL
words?}\label{study-2-what-linguistic-information-in-childrens-input-supports-their-shift-from-cdl-to-adl-words}}
...
We analyzed 131,847 other-produced utterances (i.e., utterances not
...
because it has not been comprehensively timestamped.
...
All models also revealed a positive main effect of target child age (all
...
predictive of form (\(\beta\) = 0.003, \emph{SE} = 0.02, \emph{t} =
...
ADL form (\(\beta\) = -0.063, \emph{SE} = 0.02, \emph{t} = -3.25,
...
with age (\(\beta\) = -0.01, \emph{SE} = 0.02, \emph{t} = -0.77,
\emph{p} = 0.444). \textbf{Speech rate} (i.e., words produced per
...
were more likely to contain ADL forms. Lexical complexity did not
